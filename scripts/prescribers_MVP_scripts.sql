...
-- 	npi # 1881634483 with a total of 99,707 claims
	
--     b. Repeat the above, but this time report the nppes_provider_first_name, nppes_provider_last_org_name,  specialty_description, and the total number of claims.
-- SELECT p1.npi, p1.nppes_provider_last_org_name, p1.nppes_provider_first_name, p1.specialty_description, SUM(p2.total_claim_count)
...
-- 1881634483	"PENDLEY"	"BRUCE"	"Family Practice" total claims: 99707

-- 2. 
--     a. Which specialty had the most total number of claims (totaled over all drugs)?
-- SELECT specialty_description, SUM(p2.total_claim_count)
-- FROM prescriber AS p1
-- INNER JOIN prescription AS p2
-- USING (npi)
-- INNER JOIN drug
...
-- What is meant by no associated prescriptions?
